exports.config = {
    ...
    specs: [
        ...
        './gui_tests/test_*.coffee'
    ],
    suites: {
        test_open_page: [
            './test_open_page.coffee'
        ]
    },
    // Patterns to exclude.
    exclude: [
...
if (process.env.GENERATE_JUNIT_REPORTS != null) {
    exports.config.reporters.push(
        ['junit', {
            outputDir: "./results/",
            outputFileFormat: function (options) {
                return `${options.suite}_${options.cid}.xml`
            }
        }]
    )
}
